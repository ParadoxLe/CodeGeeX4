...
from .GNN_Reflect_Enhance import GNN_Reflect_Enhance
...
def load_code_model_GNN_Reflect(config: Optional[Dict] = None) -> EnhanceModel:
    """统一加载接口，给外部脚本调用"""
    return GNN_Reflect_Enhance(config=config)
